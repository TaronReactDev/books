...
/* themes/custom/ejanshan/templates/paragraphs/paragraph--social-media-paragraph.html.twig */
class __TwigTemplate_7e01ca2cd0738aa15f2aabd5136c6ff7 extends Template
{
    private $source;
    private $macros = [];
...
";
    ...
    public function block_content($context, array $blocks = [])
    {
        ...
        <a href=\"";
        // line 53
        echo $this->extensions['Drupal\Core\Template\TwigExtension']->escapeFilter($this->env, $this->sandbox->ensureToStringAllowed((($__internal_compile_0 = twig_get_attribute($this->env, $this->source, twig_get_attribute($this->env, $this->source, ($context["content"] ?? null), "field_link", [], "any", false, false, true, 53), 0, [], "any", false, false, true, 53)) && is_array($__internal_compile_0) || $__internal_compile_0 instanceof ArrayAccess ? ($__internal_compile_0["#title"] ?? null) : null), 53, $this->source), "html", null, true);
        echo "\" target=\"_blank\" ></a>
        <i class=\"fab fa-";
        // line 54
        echo $this->extensions['Drupal\Core\Template\TwigExtension']->escapeFilter($this->env, $this->sandbox->ensureToStringAllowed(twig_get_attribute($this->env, $this->source, twig_get_attribute($this->env, $this->source, ($context["content"] ?? null), "field_bootstrap_icon_class", [], "any", false, false, true, 54), 0, [], "any", false, false, true, 54), 54, $this->source), "html", null, true);
        echo "\"></i>
      </div>
    ";
    }
    ...
    {
        return "themes/custom/ejanshan/templates/paragraphs/paragraph--social-media-paragraph.html.twig";
    }
    ...
    {
        return array (  76 => 54,  72 => 53,  69 => 52,  65 => 51,  60 => 57,  58 => 51,  53 => 50,  46 => 49,  44 => 46,  43 => 45,  42 => 44,  41 => 42,);
    }
  ...
  <div{{ attributes.addClass(classes) }}>
    {% block content %}
      <div class=\"social-icon\">
        <a href=\"{{ content.field_link.0['#title'] }}\" target=\"_blank\" ></a>
        <i class=\"fab fa-{{ content.field_bootstrap_icon_class.0 }}\"></i>
      </div>
    {% endblock %}
  </div>
{% endblock paragraph %}
", "themes/custom/ejanshan/templates/paragraphs/paragraph--social-media-paragraph.html.twig", "C:\\xampp\\htdocs\\ejanshan_bookshop\\web\\themes\\custom\\ejanshan\\templates\\paragraphs\\paragraph--social-media-paragraph.html.twig");
    }
